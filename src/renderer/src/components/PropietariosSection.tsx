...
import { Propietario, Propiedad } from '../types';
    ...
    <div className="space-y-6">
      ...
      {mostrarFormulario && (
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          <form onSubmit={handleSubmitPropietario} className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
      ...
      <div className="space-y-4">
        {propietarios.map((propietario) => {
          ...
          return (
            <div key={propietario.id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
              ...
              {mostrarFormPropiedad === propietario.id && (
                <div className="p-6 bg-gray-50 border-b border-gray-200">
                  ...
                  <form onSubmit={(e) => handleSubmitPropiedad(e, propietario.id)} className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) => setPropiedadData({...propiedadData, direccion: e.target.value})}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          required
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) => setPropiedadData({...propiedadData, tipo: e.target.value as any})}
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={(e) => setPropiedadData({...propiedadData, caracteristicas: e.target.value})}
                        rows={3}
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
